...
def main():
    ...
    selected_utxo = select_best_utxo(taproot_address.to_string(), 1000)
   ...
   # 构建交易
    ...
    txout = TxOutput(input_amount-150, alice_pub.get_taproot_address().to_script_pub_key())
    ...
    tx.witnesses.append(
        TxWitnessInput([
            secret_bytes_1.hex(),        # preimage (hex str)
            const_value_1.hex(),
